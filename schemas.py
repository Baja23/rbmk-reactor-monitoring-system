...
class Reactor:
    def __init__(self, fuel_reactivity = 5.905,  orm_value = 105, partially_inserted = 0, inlet_temp_c = 270.0, outlet_temp_c = 284.0, coolant_flow_m3h = 45000.0, tau = 10.0, thermal_power_mw = 3200.0, reactivity_delta = 0.0, xenon_level = 1.0):
    ...
    def xenon_poisoning(self, hist_thermal_power = 3200.0):
        change = ((0.00005 * hist_thermal_power) - (0.00005 * self.xenon_level * self.thermal_power_mw) - (self.xenon_level-(0.0021 * self.xenon_level)))
